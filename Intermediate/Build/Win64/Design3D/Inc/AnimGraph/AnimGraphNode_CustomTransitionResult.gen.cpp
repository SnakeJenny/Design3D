...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AnimGraphNode_CustomTransitionResult.h" },
		{ "ModuleRelativePath", "Classes/AnimGraphNode_CustomTransitionResult.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_CustomTransitionResult, 3431686672);
	template<> ANIMGRAPH_API UClass* StaticClass<UAnimGraphNode_CustomTransitionResult>()
	{
		return UAnimGraphNode_CustomTransitionResult::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimGraphNode_CustomTransitionResult(Z_Construct_UClass_UAnimGraphNode_CustomTransitionResult, &UAnimGraphNode_CustomTransitionResult::StaticClass, TEXT("/Script/AnimGraph"), TEXT("UAnimGraphNode_CustomTransitionResult"), false, nullptr, nullptr, nullptr);
