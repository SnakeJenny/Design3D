...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_PoseHandler_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AnimGraphNode_PoseHandler.h" },
		{ "ModuleRelativePath", "Classes/AnimGraphNode_PoseHandler.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimGraphNode_PoseHandler_Statics::ClassParams = {
		...
		0,
		0x000800A1u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_PoseHandler_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_PoseHandler_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UAnimGraphNode_PoseHandler()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_PoseHandler_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_PoseHandler, 2205546792);
	template<> ANIMGRAPH_API UClass* StaticClass<UAnimGraphNode_PoseHandler>()
	{
		return UAnimGraphNode_PoseHandler::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimGraphNode_PoseHandler(Z_Construct_UClass_UAnimGraphNode_PoseHandler, &UAnimGraphNode_PoseHandler::StaticClass, TEXT("/Script/AnimGraph"), TEXT("UAnimGraphNode_PoseHandler"), false, nullptr, nullptr, nullptr);
