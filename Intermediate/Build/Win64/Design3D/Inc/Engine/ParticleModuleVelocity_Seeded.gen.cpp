...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleVelocity_Seeded_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UParticleModuleVelocity_Seeded_Statics::PropPointers),
		0,
		0x008010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UParticleModuleVelocity_Seeded_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UParticleModuleVelocity_Seeded_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UParticleModuleVelocity_Seeded, 540720291);
