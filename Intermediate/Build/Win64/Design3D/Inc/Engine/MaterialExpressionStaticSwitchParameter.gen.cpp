...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionStaticSwitchParameter_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionStaticSwitchParameter, B), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionStaticSwitchParameter_Statics::NewProp_B_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionStaticSwitchParameter_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionStaticSwitchParameter_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionStaticSwitchParameter_Statics::PropPointers),
		0,
		0x000820A0u,
	...
	IMPLEMENT_CLASS(UMaterialExpressionStaticSwitchParameter, 3263955900);
