...
#include "BehaviorTreeEditor/Classes/BehaviorTreeEditorTypes.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBehaviorTreeEditorTypes_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBehaviorTreeEditorTypes_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeEditorTypes_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeEditorTypes_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UBehaviorTreeEditorTypes()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UBehaviorTreeEditorTypes_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UBehaviorTreeEditorTypes, 4278728526);
	template<> BEHAVIORTREEEDITOR_API UClass* StaticClass<UBehaviorTreeEditorTypes>()
	{
		return UBehaviorTreeEditorTypes::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBehaviorTreeEditorTypes(Z_Construct_UClass_UBehaviorTreeEditorTypes, &UBehaviorTreeEditorTypes::StaticClass, TEXT("/Script/BehaviorTreeEditor"), TEXT("UBehaviorTreeEditorTypes"), false, nullptr, nullptr, nullptr);
