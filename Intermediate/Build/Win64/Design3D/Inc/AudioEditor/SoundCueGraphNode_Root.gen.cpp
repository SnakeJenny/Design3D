...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundCueGraphNode_Root_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundCueGraphNode_Root_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_USoundCueGraphNode_Root_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USoundCueGraphNode_Root_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_USoundCueGraphNode_Root()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USoundCueGraphNode_Root_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USoundCueGraphNode_Root, 3579400562);
	template<> AUDIOEDITOR_API UClass* StaticClass<USoundCueGraphNode_Root>()
	{
		return USoundCueGraphNode_Root::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USoundCueGraphNode_Root(Z_Construct_UClass_USoundCueGraphNode_Root, &USoundCueGraphNode_Root::StaticClass, TEXT("/Script/AudioEditor"), TEXT("USoundCueGraphNode_Root"), false, nullptr, nullptr, nullptr);
