...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UReverbEffectFactory_Statics::Class_MetaDataParams[] = {
		{ "HideCategories", "Object" },
		{ "IncludePath", "Factories/ReverbEffectFactory.h" },
		{ "ModuleRelativePath", "Classes/Factories/ReverbEffectFactory.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UReverbEffectFactory_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UReverbEffectFactory>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UReverbEffectFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UReverbEffectFactory_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UReverbEffectFactory_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UReverbEffectFactory()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UReverbEffectFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UReverbEffectFactory, 1137210415);
	template<> AUDIOEDITOR_API UClass* StaticClass<UReverbEffectFactory>()
	{
		return UReverbEffectFactory::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UReverbEffectFactory(Z_Construct_UClass_UReverbEffectFactory, &UReverbEffectFactory::StaticClass, TEXT("/Script/AudioEditor"), TEXT("UReverbEffectFactory"), false, nullptr, nullptr, nullptr);
