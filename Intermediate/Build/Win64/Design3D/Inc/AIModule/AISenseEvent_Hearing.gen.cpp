...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAISenseEvent_Hearing_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAISenseEvent_Hearing_Statics::PropPointers),
		0,
		0x001010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAISenseEvent_Hearing_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAISenseEvent_Hearing_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAISenseEvent_Hearing, 512038008);
