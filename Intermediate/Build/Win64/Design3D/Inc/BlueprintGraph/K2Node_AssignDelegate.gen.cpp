...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_AssignDelegate_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_AssignDelegate_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_AssignDelegate_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UK2Node_AssignDelegate_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UK2Node_AssignDelegate()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UK2Node_AssignDelegate_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UK2Node_AssignDelegate, 3929011044);
	template<> BLUEPRINTGRAPH_API UClass* StaticClass<UK2Node_AssignDelegate>()
	{
		return UK2Node_AssignDelegate::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UK2Node_AssignDelegate(Z_Construct_UClass_UK2Node_AssignDelegate, &UK2Node_AssignDelegate::StaticClass, TEXT("/Script/BlueprintGraph"), TEXT("UK2Node_AssignDelegate"), false, nullptr, nullptr, nullptr);
