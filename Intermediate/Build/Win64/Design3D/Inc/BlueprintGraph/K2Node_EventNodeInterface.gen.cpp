...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_EventNodeInterface_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_EventNodeInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_EventNodeInterface_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UK2Node_EventNodeInterface_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UK2Node_EventNodeInterface()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UK2Node_EventNodeInterface_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UK2Node_EventNodeInterface, 3543787318);
	template<> BLUEPRINTGRAPH_API UClass* StaticClass<UK2Node_EventNodeInterface>()
	{
		return UK2Node_EventNodeInterface::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UK2Node_EventNodeInterface(Z_Construct_UClass_UK2Node_EventNodeInterface, &UK2Node_EventNodeInterface::StaticClass, TEXT("/Script/BlueprintGraph"), TEXT("UK2Node_EventNodeInterface"), false, nullptr, nullptr, nullptr);
