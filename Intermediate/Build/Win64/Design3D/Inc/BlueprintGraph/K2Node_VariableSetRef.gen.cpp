...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_VariableSetRef_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_VariableSetRef_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_VariableSetRef_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UK2Node_VariableSetRef_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UK2Node_VariableSetRef()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UK2Node_VariableSetRef_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UK2Node_VariableSetRef, 308304147);
	template<> BLUEPRINTGRAPH_API UClass* StaticClass<UK2Node_VariableSetRef>()
	{
		return UK2Node_VariableSetRef::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UK2Node_VariableSetRef(Z_Construct_UClass_UK2Node_VariableSetRef, &UK2Node_VariableSetRef::StaticClass, TEXT("/Script/BlueprintGraph"), TEXT("UK2Node_VariableSetRef"), false, nullptr, nullptr, nullptr);
