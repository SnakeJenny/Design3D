...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlueprintBoundNodeSpawner_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBlueprintBoundNodeSpawner_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UBlueprintBoundNodeSpawner_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UBlueprintBoundNodeSpawner_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UBlueprintBoundNodeSpawner()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UBlueprintBoundNodeSpawner_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UBlueprintBoundNodeSpawner, 3776668130);
	template<> BLUEPRINTGRAPH_API UClass* StaticClass<UBlueprintBoundNodeSpawner>()
	{
		return UBlueprintBoundNodeSpawner::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBlueprintBoundNodeSpawner(Z_Construct_UClass_UBlueprintBoundNodeSpawner, &UBlueprintBoundNodeSpawner::StaticClass, TEXT("/Script/BlueprintGraph"), TEXT("UBlueprintBoundNodeSpawner"), false, nullptr, nullptr, nullptr);
