...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_CallDelegate_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_CallDelegate_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_CallDelegate_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UK2Node_CallDelegate_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UK2Node_CallDelegate()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UK2Node_CallDelegate_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UK2Node_CallDelegate, 492792137);
	template<> BLUEPRINTGRAPH_API UClass* StaticClass<UK2Node_CallDelegate>()
	{
		return UK2Node_CallDelegate::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UK2Node_CallDelegate(Z_Construct_UClass_UK2Node_CallDelegate, &UK2Node_CallDelegate::StaticClass, TEXT("/Script/BlueprintGraph"), TEXT("UK2Node_CallDelegate"), false, nullptr, nullptr, nullptr);
