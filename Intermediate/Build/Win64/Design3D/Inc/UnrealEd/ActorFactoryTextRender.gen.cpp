...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactoryTextRender_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryTextRender_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactoryTextRender_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactoryTextRender_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactoryTextRender()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactoryTextRender_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactoryTextRender, 884890451);
	template<> UNREALED_API UClass* StaticClass<UActorFactoryTextRender>()
	{
		return UActorFactoryTextRender::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactoryTextRender(Z_Construct_UClass_UActorFactoryTextRender, &UActorFactoryTextRender::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactoryTextRender"), false, nullptr, nullptr, nullptr);
