...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UThumbnailRenderer_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000800A1u,
		METADATA_PARAMS(Z_Construct_UClass_UThumbnailRenderer_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UThumbnailRenderer_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UThumbnailRenderer, 3745228206);
	template<> UNREALED_API UClass* StaticClass<UThumbnailRenderer>()
	{
		return UThumbnailRenderer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UThumbnailRenderer(Z_Construct_UClass_UThumbnailRenderer, &UThumbnailRenderer::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UThumbnailRenderer"), false, nullptr, nullptr, nullptr);
