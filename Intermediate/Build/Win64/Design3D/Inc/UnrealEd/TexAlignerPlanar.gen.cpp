...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTexAlignerPlanar_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTexAlignerPlanar_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UTexAlignerPlanar_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UTexAlignerPlanar_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UTexAlignerPlanar()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UTexAlignerPlanar_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UTexAlignerPlanar, 2336658473);
	template<> UNREALED_API UClass* StaticClass<UTexAlignerPlanar>()
	{
		return UTexAlignerPlanar::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UTexAlignerPlanar(Z_Construct_UClass_UTexAlignerPlanar, &UTexAlignerPlanar::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UTexAlignerPlanar"), false, nullptr, nullptr, nullptr);
