...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSurroundExporterWAV_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundSurroundExporterWAV_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_USoundSurroundExporterWAV_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USoundSurroundExporterWAV_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_USoundSurroundExporterWAV()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USoundSurroundExporterWAV_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USoundSurroundExporterWAV, 2303632547);
	template<> UNREALED_API UClass* StaticClass<USoundSurroundExporterWAV>()
	{
		return USoundSurroundExporterWAV::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USoundSurroundExporterWAV(Z_Construct_UClass_USoundSurroundExporterWAV, &USoundSurroundExporterWAV::StaticClass, TEXT("/Script/UnrealEd"), TEXT("USoundSurroundExporterWAV"), false, nullptr, nullptr, nullptr);
