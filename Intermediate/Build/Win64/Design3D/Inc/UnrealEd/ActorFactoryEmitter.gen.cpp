...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactoryEmitter_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryEmitter_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactoryEmitter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactoryEmitter_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactoryEmitter()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactoryEmitter_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactoryEmitter, 2827903665);
	template<> UNREALED_API UClass* StaticClass<UActorFactoryEmitter>()
	{
		return UActorFactoryEmitter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactoryEmitter(Z_Construct_UClass_UActorFactoryEmitter, &UActorFactoryEmitter::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactoryEmitter"), false, nullptr, nullptr, nullptr);
