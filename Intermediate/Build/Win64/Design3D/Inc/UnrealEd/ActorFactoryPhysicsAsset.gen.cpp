...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactoryPhysicsAsset_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryPhysicsAsset_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactoryPhysicsAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactoryPhysicsAsset_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactoryPhysicsAsset()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactoryPhysicsAsset_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactoryPhysicsAsset, 3329479948);
	template<> UNREALED_API UClass* StaticClass<UActorFactoryPhysicsAsset>()
	{
		return UActorFactoryPhysicsAsset::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactoryPhysicsAsset(Z_Construct_UClass_UActorFactoryPhysicsAsset, &UActorFactoryPhysicsAsset::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactoryPhysicsAsset"), false, nullptr, nullptr, nullptr);
