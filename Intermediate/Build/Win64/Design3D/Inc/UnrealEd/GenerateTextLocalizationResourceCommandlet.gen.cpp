...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UGenerateTextLocalizationResourceCommandlet, 2594520893);
	template<> UNREALED_API UClass* StaticClass<UGenerateTextLocalizationResourceCommandlet>()
	{
		return UGenerateTextLocalizationResourceCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UGenerateTextLocalizationResourceCommandlet(Z_Construct_UClass_UGenerateTextLocalizationResourceCommandlet, &UGenerateTextLocalizationResourceCommandlet::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UGenerateTextLocalizationResourceCommandlet"), false, nullptr, nullptr, nullptr);
