...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialInstanceThumbnailRenderer_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialInstanceThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UMaterialInstanceThumbnailRenderer_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMaterialInstanceThumbnailRenderer_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UMaterialInstanceThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialInstanceThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialInstanceThumbnailRenderer, 1936886532);
	template<> UNREALED_API UClass* StaticClass<UMaterialInstanceThumbnailRenderer>()
	{
		return UMaterialInstanceThumbnailRenderer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialInstanceThumbnailRenderer(Z_Construct_UClass_UMaterialInstanceThumbnailRenderer, &UMaterialInstanceThumbnailRenderer::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UMaterialInstanceThumbnailRenderer"), false, nullptr, nullptr, nullptr);
