...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundExporterWAV_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USoundExporterWAV_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_USoundExporterWAV_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USoundExporterWAV_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_USoundExporterWAV()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USoundExporterWAV_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USoundExporterWAV, 137036921);
	template<> UNREALED_API UClass* StaticClass<USoundExporterWAV>()
	{
		return USoundExporterWAV::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USoundExporterWAV(Z_Construct_UClass_USoundExporterWAV, &USoundExporterWAV::StaticClass, TEXT("/Script/UnrealEd"), TEXT("USoundExporterWAV"), false, nullptr, nullptr, nullptr);
