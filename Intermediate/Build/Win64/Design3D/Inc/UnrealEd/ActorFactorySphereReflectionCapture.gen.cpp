...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactorySphereReflectionCapture_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactorySphereReflectionCapture_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactorySphereReflectionCapture_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactorySphereReflectionCapture_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactorySphereReflectionCapture()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactorySphereReflectionCapture_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactorySphereReflectionCapture, 2254449151);
	template<> UNREALED_API UClass* StaticClass<UActorFactorySphereReflectionCapture>()
	{
		return UActorFactorySphereReflectionCapture::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactorySphereReflectionCapture(Z_Construct_UClass_UActorFactorySphereReflectionCapture, &UActorFactorySphereReflectionCapture::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactorySphereReflectionCapture"), false, nullptr, nullptr, nullptr);
