...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGenerateGatherArchiveCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGenerateGatherArchiveCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UGenerateGatherArchiveCommandlet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGenerateGatherArchiveCommandlet_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UGenerateGatherArchiveCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UGenerateGatherArchiveCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UGenerateGatherArchiveCommandlet, 396688120);
	template<> UNREALED_API UClass* StaticClass<UGenerateGatherArchiveCommandlet>()
	{
		return UGenerateGatherArchiveCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UGenerateGatherArchiveCommandlet(Z_Construct_UClass_UGenerateGatherArchiveCommandlet, &UGenerateGatherArchiveCommandlet::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UGenerateGatherArchiveCommandlet"), false, nullptr, nullptr, nullptr);
