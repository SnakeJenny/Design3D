...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactoryAmbientSound_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryAmbientSound_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactoryAmbientSound_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactoryAmbientSound_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactoryAmbientSound()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactoryAmbientSound_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactoryAmbientSound, 3488907220);
	template<> UNREALED_API UClass* StaticClass<UActorFactoryAmbientSound>()
	{
		return UActorFactoryAmbientSound::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactoryAmbientSound(Z_Construct_UClass_UActorFactoryAmbientSound, &UActorFactoryAmbientSound::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactoryAmbientSound"), false, nullptr, nullptr, nullptr);
