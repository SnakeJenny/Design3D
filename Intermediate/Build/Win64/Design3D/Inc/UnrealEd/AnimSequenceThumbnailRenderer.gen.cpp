...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimSequenceThumbnailRenderer_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimSequenceThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimSequenceThumbnailRenderer_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceThumbnailRenderer_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UAnimSequenceThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimSequenceThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimSequenceThumbnailRenderer, 1714304036);
	template<> UNREALED_API UClass* StaticClass<UAnimSequenceThumbnailRenderer>()
	{
		return UAnimSequenceThumbnailRenderer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimSequenceThumbnailRenderer(Z_Construct_UClass_UAnimSequenceThumbnailRenderer, &UAnimSequenceThumbnailRenderer::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UAnimSequenceThumbnailRenderer"), false, nullptr, nullptr, nullptr);
