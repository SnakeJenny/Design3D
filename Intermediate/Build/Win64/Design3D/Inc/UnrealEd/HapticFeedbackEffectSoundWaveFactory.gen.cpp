...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UHapticFeedbackEffectSoundWaveFactory, 3090022997);
	template<> UNREALED_API UClass* StaticClass<UHapticFeedbackEffectSoundWaveFactory>()
	{
		return UHapticFeedbackEffectSoundWaveFactory::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHapticFeedbackEffectSoundWaveFactory(Z_Construct_UClass_UHapticFeedbackEffectSoundWaveFactory, &UHapticFeedbackEffectSoundWaveFactory::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UHapticFeedbackEffectSoundWaveFactory"), false, nullptr, nullptr, nullptr);
