...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UExportPakDependenciesCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UExportPakDependenciesCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UExportPakDependenciesCommandlet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UExportPakDependenciesCommandlet_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UExportPakDependenciesCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UExportPakDependenciesCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UExportPakDependenciesCommandlet, 83666902);
	template<> UNREALED_API UClass* StaticClass<UExportPakDependenciesCommandlet>()
	{
		return UExportPakDependenciesCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UExportPakDependenciesCommandlet(Z_Construct_UClass_UExportPakDependenciesCommandlet, &UExportPakDependenciesCommandlet::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UExportPakDependenciesCommandlet"), false, nullptr, nullptr, nullptr);
