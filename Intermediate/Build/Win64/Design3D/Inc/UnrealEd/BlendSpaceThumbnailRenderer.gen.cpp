...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpaceThumbnailRenderer_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBlendSpaceThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceThumbnailRenderer_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceThumbnailRenderer_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UBlendSpaceThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UBlendSpaceThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UBlendSpaceThumbnailRenderer, 3556030845);
	template<> UNREALED_API UClass* StaticClass<UBlendSpaceThumbnailRenderer>()
	{
		return UBlendSpaceThumbnailRenderer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBlendSpaceThumbnailRenderer(Z_Construct_UClass_UBlendSpaceThumbnailRenderer, &UBlendSpaceThumbnailRenderer::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UBlendSpaceThumbnailRenderer"), false, nullptr, nullptr, nullptr);
