...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UForceFeedbackAttenuationFactory_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UForceFeedbackAttenuationFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UForceFeedbackAttenuationFactory_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UForceFeedbackAttenuationFactory_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UForceFeedbackAttenuationFactory()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UForceFeedbackAttenuationFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UForceFeedbackAttenuationFactory, 1814290934);
	template<> UNREALED_API UClass* StaticClass<UForceFeedbackAttenuationFactory>()
	{
		return UForceFeedbackAttenuationFactory::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UForceFeedbackAttenuationFactory(Z_Construct_UClass_UForceFeedbackAttenuationFactory, &UForceFeedbackAttenuationFactory::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UForceFeedbackAttenuationFactory"), false, nullptr, nullptr, nullptr);
