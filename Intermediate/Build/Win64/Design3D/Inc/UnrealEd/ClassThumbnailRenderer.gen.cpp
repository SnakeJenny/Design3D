...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UClassThumbnailRenderer_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UClassThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(Z_Construct_UClass_UClassThumbnailRenderer_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UClassThumbnailRenderer_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UClassThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UClassThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UClassThumbnailRenderer, 3372829214);
	template<> UNREALED_API UClass* StaticClass<UClassThumbnailRenderer>()
	{
		return UClassThumbnailRenderer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UClassThumbnailRenderer(Z_Construct_UClass_UClassThumbnailRenderer, &UClassThumbnailRenderer::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UClassThumbnailRenderer"), false, nullptr, nullptr, nullptr);
