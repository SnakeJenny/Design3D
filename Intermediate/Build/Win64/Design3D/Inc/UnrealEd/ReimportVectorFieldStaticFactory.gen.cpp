...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UReimportVectorFieldStaticFactory_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UReimportVectorFieldStaticFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UReimportVectorFieldStaticFactory_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UReimportVectorFieldStaticFactory_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UReimportVectorFieldStaticFactory()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UReimportVectorFieldStaticFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UReimportVectorFieldStaticFactory, 4088981328);
	template<> UNREALED_API UClass* StaticClass<UReimportVectorFieldStaticFactory>()
	{
		return UReimportVectorFieldStaticFactory::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UReimportVectorFieldStaticFactory(Z_Construct_UClass_UReimportVectorFieldStaticFactory, &UReimportVectorFieldStaticFactory::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UReimportVectorFieldStaticFactory"), false, nullptr, nullptr, nullptr);
