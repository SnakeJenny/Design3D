...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactoryTargetPoint_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryTargetPoint_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactoryTargetPoint_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactoryTargetPoint_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactoryTargetPoint()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactoryTargetPoint_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactoryTargetPoint, 2911832368);
	template<> UNREALED_API UClass* StaticClass<UActorFactoryTargetPoint>()
	{
		return UActorFactoryTargetPoint::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactoryTargetPoint(Z_Construct_UClass_UActorFactoryTargetPoint, &UActorFactoryTargetPoint::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactoryTargetPoint"), false, nullptr, nullptr, nullptr);
