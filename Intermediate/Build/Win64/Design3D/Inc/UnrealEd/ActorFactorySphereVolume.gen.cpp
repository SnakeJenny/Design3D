...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactorySphereVolume_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactorySphereVolume_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactorySphereVolume_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactorySphereVolume_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactorySphereVolume()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactorySphereVolume_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactorySphereVolume, 3682788906);
	template<> UNREALED_API UClass* StaticClass<UActorFactorySphereVolume>()
	{
		return UActorFactorySphereVolume::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactorySphereVolume(Z_Construct_UClass_UActorFactorySphereVolume, &UActorFactorySphereVolume::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactorySphereVolume"), false, nullptr, nullptr, nullptr);
