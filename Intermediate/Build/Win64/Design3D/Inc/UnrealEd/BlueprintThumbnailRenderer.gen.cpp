...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlueprintThumbnailRenderer_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBlueprintThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(Z_Construct_UClass_UBlueprintThumbnailRenderer_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UBlueprintThumbnailRenderer_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UBlueprintThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UBlueprintThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UBlueprintThumbnailRenderer, 3754367518);
	template<> UNREALED_API UClass* StaticClass<UBlueprintThumbnailRenderer>()
	{
		return UBlueprintThumbnailRenderer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBlueprintThumbnailRenderer(Z_Construct_UClass_UBlueprintThumbnailRenderer, &UBlueprintThumbnailRenderer::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UBlueprintThumbnailRenderer"), false, nullptr, nullptr, nullptr);
