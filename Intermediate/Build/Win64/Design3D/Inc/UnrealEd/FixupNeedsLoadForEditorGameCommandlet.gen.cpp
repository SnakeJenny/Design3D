...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UFixupNeedsLoadForEditorGameCommandlet, 3259775353);
	template<> UNREALED_API UClass* StaticClass<UFixupNeedsLoadForEditorGameCommandlet>()
	{
		return UFixupNeedsLoadForEditorGameCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFixupNeedsLoadForEditorGameCommandlet(Z_Construct_UClass_UFixupNeedsLoadForEditorGameCommandlet, &UFixupNeedsLoadForEditorGameCommandlet::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UFixupNeedsLoadForEditorGameCommandlet"), false, nullptr, nullptr, nullptr);
