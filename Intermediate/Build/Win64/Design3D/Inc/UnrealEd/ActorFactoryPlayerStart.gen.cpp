...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorFactoryPlayerStart_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryPlayerStart_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(Z_Construct_UClass_UActorFactoryPlayerStart_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorFactoryPlayerStart_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UActorFactoryPlayerStart()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UActorFactoryPlayerStart_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UActorFactoryPlayerStart, 635526486);
	template<> UNREALED_API UClass* StaticClass<UActorFactoryPlayerStart>()
	{
		return UActorFactoryPlayerStart::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UActorFactoryPlayerStart(Z_Construct_UClass_UActorFactoryPlayerStart, &UActorFactoryPlayerStart::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UActorFactoryPlayerStart"), false, nullptr, nullptr, nullptr);
