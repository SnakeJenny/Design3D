...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleSystemFactoryNew_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleSystemFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UParticleSystemFactoryNew_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UParticleSystemFactoryNew_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UParticleSystemFactoryNew()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UParticleSystemFactoryNew_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UParticleSystemFactoryNew, 3427269552);
	template<> UNREALED_API UClass* StaticClass<UParticleSystemFactoryNew>()
	{
		return UParticleSystemFactoryNew::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UParticleSystemFactoryNew(Z_Construct_UClass_UParticleSystemFactoryNew, &UParticleSystemFactoryNew::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UParticleSystemFactoryNew"), false, nullptr, nullptr, nullptr);
