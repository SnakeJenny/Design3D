...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UReplaceAssetsCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UReplaceAssetsCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UReplaceAssetsCommandlet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UReplaceAssetsCommandlet_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UReplaceAssetsCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UReplaceAssetsCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UReplaceAssetsCommandlet, 2374954240);
	template<> UNREALED_API UClass* StaticClass<UReplaceAssetsCommandlet>()
	{
		return UReplaceAssetsCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UReplaceAssetsCommandlet(Z_Construct_UClass_UReplaceAssetsCommandlet, &UReplaceAssetsCommandlet::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UReplaceAssetsCommandlet"), false, nullptr, nullptr, nullptr);
