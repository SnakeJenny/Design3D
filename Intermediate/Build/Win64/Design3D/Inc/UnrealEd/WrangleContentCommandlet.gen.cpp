...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWrangleContentCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UWrangleContentCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UWrangleContentCommandlet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UWrangleContentCommandlet_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UWrangleContentCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UWrangleContentCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UWrangleContentCommandlet, 1247396508);
	template<> UNREALED_API UClass* StaticClass<UWrangleContentCommandlet>()
	{
		return UWrangleContentCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UWrangleContentCommandlet(Z_Construct_UClass_UWrangleContentCommandlet, &UWrangleContentCommandlet::StaticClass, TEXT("/Script/UnrealEd"), TEXT("UWrangleContentCommandlet"), false, nullptr, nullptr, nullptr);
