...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneCameraAnimTrack_Statics::NewProp_CameraAnimSections = { "CameraAnimSections", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCameraAnimTrack, CameraAnimSections), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCameraAnimTrack_Statics::NewProp_CameraAnimSections_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraAnimTrack_Statics::NewProp_CameraAnimSections_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneCameraAnimTrack_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraAnimTrack_Statics::PropPointers),
		0,
		0x00A800A0u,
	...
	IMPLEMENT_CLASS(UMovieSceneCameraAnimTrack, 412338247);
