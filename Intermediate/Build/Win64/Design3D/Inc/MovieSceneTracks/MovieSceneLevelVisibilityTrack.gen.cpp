...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneLevelVisibilityTrack, Sections), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::NewProp_Sections_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::NewProp_Sections_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::PropPointers),
		0,
		0x00A800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLevelVisibilityTrack_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovieSceneLevelVisibilityTrack, 90796796);
