...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UWidgetBinding_GetValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWidgetBinding, nullptr, "GetValue", sizeof(WidgetBinding_eventGetValue_Parms), Z_Construct_UFunction_UWidgetBinding_GetValue_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UWidgetBinding_GetValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UWidgetBinding_GetValue_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UWidgetBinding_GetValue_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWidgetBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UWidgetBinding_GetValue, "GetValue" }, // 3846158058
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UWidgetBinding, 3116952882);
