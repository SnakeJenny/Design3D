...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlaySlot, nullptr, "SetHorizontalAlignment", sizeof(OverlaySlot_eventSetHorizontalAlignment_Parms), Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlaySlot, nullptr, "SetPadding", sizeof(OverlaySlot_eventSetPadding_Parms), Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOverlaySlot, nullptr, "SetVerticalAlignment", sizeof(OverlaySlot_eventSetVerticalAlignment_Parms), Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOverlaySlot_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment, "SetHorizontalAlignment" }, // 4113386204
		{ &Z_Construct_UFunction_UOverlaySlot_SetPadding, "SetPadding" }, // 2419773212
		{ &Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment, "SetVerticalAlignment" }, // 2223250872
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOverlaySlot_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UOverlaySlot_Statics::PropPointers),
		0,
		0x00B000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOverlaySlot_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOverlaySlot_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOverlaySlot, 1314874693);
